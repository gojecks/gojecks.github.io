(function()
{
	...
	'use strict';
	var module = jEli
		.jModule('eliTest',['jEli.Date.Time','jEli.web.route']);
...
.jFactory('anotherFactory',['testFactory','$jEliWebProvider',function(testFactory,$jEliWebProvider)
{
...
.jElement('tableTester',["anotherFactory","$webState",function(anotherFactory,$webState)
{
...
.jController('baseCtrl',["$scope","$webState","$rootModel",function($scope,$webState,$rootModel)
{
